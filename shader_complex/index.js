...
var tex1 = twgl.createTexture(gl, {
  min: gl.NEAREST,
  mag: gl.NEAREST,
  src: './earth.jpg',
});
...
var objectsToDraw = [
  {
    ...
    uniforms: objectUniforms[0],
  },
  {
    programInfo: programInfo,
    bufferInfo: sphereBufferInfo,
    uniforms: objectUniforms[1],
  },
  {
    programInfo: programInfo,
    bufferInfo: sphereBufferInfo,
    uniforms: objectUniforms[2],
  },
]
...
function render(time) {
  ...
  var world0 = m4.translation(v3.mulScalar(v3.create(-0.2, 0.2, 1), 20))
  world0 = m4.scale(world0,v3.mulScalar(v3.create(1, 1, 1), 3))

  var world1 = m4.rotationY(time)
  world1 = m4.rotateX(world1, time)
